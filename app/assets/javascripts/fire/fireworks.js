  ...
  var abcindex = ['أ', 'ب', 'ت', 'ث','ج','ح','خ','د','ذ','ر', 'ز', 'س','ش','ص', 'ض', 'ط','ظ','ع','غ','ف','ق','ك','ل','م','ن','هـ','و','ي'];
  var textToWrite;
...
var elem2 = document.getElementById("footy");
...
//mainCanvas = document.getElementById("hamada");
mainContext = mainCanvas.getContext('2d');
// mainContext.fillStyle = "red";
// mainContext.fillRect(20, 20, 75, 50);

// //Turn transparency on
// mainContext.globalAlpha = 0.2;
// mainContext.fillStyle = "blue"; 
// mainContext.fillRect(50, 50, 75, 50); 
// mainContext.fillStyle = "green"; 
// mainContext.fillRect(80, 80, 75, 50);
  ...
  function createFireworkPalette(gridSize) {
    ...
    for(var c = 0; c < 100; c++) {
     ...
     //fireworkContext.fillStyle = "rgba(200,0,0,0.5)";
  ...
  function setMainCanvasDimensions() {
    ...
    mainCanvas.height = viewportHeight-100;
  }
  ...
  function clearContext() {
    ...
    mainContext.fillStyle = "rgba(45,45,45,0.1)";
    //mainContext.clearRect(0,0,viewportWidth,viewportHeight));
textToWrite=abcindex[lettoz-1];
//textToWrite=abcindex[2];
    mainContext.fillRect(0, 0, viewportWidth, viewportHeight);
      mainContext.font = "400px Arial";
           mainContext.fillStyle = "#FF7519";
           mainContext.textAlign = "center";
           mainContext.textBaseline = "middle";
           mainContext.fillText(textToWrite, viewportWidth/2, (viewportHeight / 2)-100);
