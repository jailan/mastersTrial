...
(function() {
	...
	sprite = new Image();
	sprite.src = 'http://localhost:3000/assets/images3/sprite.png';

	target = new Image();
	target.src = 'http://localhost:3000/assets/images3/target.gif';
	
	explosion = new Image();
	explosion.src = 'http://localhost:3000/assets/images3/explosion.png';
	...
	var myAudio = new Audio('http://localhost:3000/assets/background-music.wav');
	myAudio.loop = true;
	//myAudio.play();

	// Pre-load
	bang = new Audio('http://localhost:3000/assets/bang.wav');
    }
	...
	explosions.push(new Explosion(targetX, targetY, new Audio('http://localhost:3000/assets/bang.wav')));
	shots++;
    }
